export const translations = {
  "id": {
      ...
      "features": [
        {
          ...
          "desc": "AI memantau jaringan Anda setiap detik."
        },
        {
          "icon": "BarChart",
          "title": "Dashboard Terpusat",
          "desc": "Pantau aset dari satu dashboard."
        },
        {
          "icon": "Zap",
          "title": "Respon Cepat",
          "desc": "Tim ahli merespon dalam hitungan menit."
        }
      ],
      ...
      "faqs": [
        {
          ...
          "a": "Ya, kami menyediakan demo gratis selama 14 hari."
        },
        {
          "q": "Bagaimana proses instalasi?",
          "a": "Tim kami akan membantu instalasi dan konfigurasi penuh."
        },
        {
          "q": "Apakah data saya aman?",
          "a": "Data dienkripsi end-to-end dan disimpan di server lokal Indonesia."
        }
      ],
    ...
    "roi": {
      ...
      "disclaimer": "Estimasi berdasarkan data industri retail Indonesia.",
  ...
  "en": {
      ...
      "features": [
        {
          ...
          "desc": "AI monitors your network every second."
        },
        {
          "icon": "BarChart",
          "title": "Centralized Dashboard",
          "desc": "Monitor assets from one dashboard."
        },
        {
          "icon": "Zap",
          "title": "Fast Response",
          "desc": "Expert team responds in minutes."
        }
      ],
      ...
      "faqs": [
        {
          ...
          "a": "Yes, we provide a free demo for 14 days."
        },
        {
          "q": "How does installation work?",
          "a": "Our team will assist with full installation and configuration."
        },
        {
          "q": "Is my data safe?",
          "a": "Data is end-to-end encrypted and stored on local Indonesian servers."
        }
      ],
    ...
    "roi": {
      ...
      "disclaimer": "Estimates based on Indonesian retail industry data.",
